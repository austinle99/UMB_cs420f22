...
Proof.
 ...
 intros Z.
 intros Q.
 apply yield_def with (u:= []) (v:= []) (w:= Z) (A:= Y).
 - simpl.
   apply Q.
 - simpl.
   reflexivity.
...
Proof.
 ...
 rewrite <- app_assoc.
 rewrite <- app_assoc.
 apply yield_def with (u := u) (v:= v ++ D) (w:= w) (A := A).
 - simpl.
   apply H.
 - simpl.
   reflexivity.
...
Proof.
 ...
 rewrite -> H0.
 rewrite -> H1.
 apply yield_def with (u:= D++u) (v:= v) (w:= w) (A:= A).
 - simpl.
   apply H.
 - simpl.
   rewrite -> app_assoc.
